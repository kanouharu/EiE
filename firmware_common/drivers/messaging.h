...
Queue size in bytes is U8_TX_QUEUE_SIZE x MAX_TX_MESSAGE_LENGTH */
...
#define TX_QUEUE_WATERMARK              (u8)(U8_TX_QUEUE_SIZE - 3) /* Number of messages in the queue that will trigger a warning flag */
#define U8_STATUS_QUEUE_SIZE               (u8)(2 * U8_TX_QUEUE_SIZE)   /* Number of message statusi to maintain */
